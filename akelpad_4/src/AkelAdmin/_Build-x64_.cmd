@rem :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@rem :: Script.......: _Build-x64_.cmd                                        ::
@rem :: Location.....: .\src\AkelAdmin\                                       ::
@rem :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
cl /O1 %CLFLAGS% AkelAdmin.c AkelAdmin.res /link kernel32.lib user32.lib advapi32.lib /SUBSYSTEM:WINDOWS /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:_WinMain /OUT:AkelAdmin64.exe
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
