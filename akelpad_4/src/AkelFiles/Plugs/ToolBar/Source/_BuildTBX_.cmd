@rem :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@rem :: Script.......: _Build-ToolBarExtra32_.cmd                             ::
...
rc /R /DRC_VERSIONBIT=%BIT% /Fo"ToolBarExtra.res" "Resources\ToolBarExtra.rc"
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
cl /O1 %CLFLAGS% ToolBarExtra.c ToolBarExtra.res /LD /link kernel32.lib user32.lib gdi32.lib advapi32.lib comctl32.lib ole32.lib /OPT:NOWIN98 /MACHINE:%MACHINE% /NODEFAULTLIB /ENTRY:DllMain
if not %ERRORLEVEL% == 0 set EXITCODE=%ERRORLEVEL%
